...
const char* SERVER_URL = "http://192.168.1.100/automatic-watering-system/api";  // Change to your server IP
const char* API_KEY = "your_device_api_key_here";  // Get this from device registration
...
#define DATA_SUBMIT_INTERVAL 300000   // Submit data every 5 minutes
#define COMMAND_POLL_INTERVAL 10000   // Poll for commands every 10 seconds
