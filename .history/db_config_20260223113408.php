...
$alterStatements = [
    "ALTER TABLE users ADD COLUMN first_name VARCHAR(100) IF NOT EXISTS",
    "ALTER TABLE users ADD COLUMN last_name VARCHAR(100) IF NOT EXISTS",
    "ALTER TABLE users ADD COLUMN email_verified BOOLEAN DEFAULT 0 IF NOT EXISTS",
    "ALTER TABLE users ADD COLUMN verification_code VARCHAR(255) IF NOT EXISTS",
    "ALTER TABLE users ADD COLUMN verification_code_expires DATETIME IF NOT EXISTS",
    "ALTER TABLE users ADD COLUMN password_reset_code VARCHAR(255) IF NOT EXISTS",
    "ALTER TABLE users ADD COLUMN password_reset_expires DATETIME IF NOT EXISTS"
];
